...
function Login() {
  ...
  if (token) {
    return <Navigate to="/task3/products" replace />;
  }
  ...
  return (
    <div className="container task3-login">
      <div className="row justify-content-center">
        <h1 className="h3 mb-3 font-weight-normal">請先登入</h1>
        <div className="col-8">
          <form id="form" className="task3-form-signin" onSubmit={handleSubmit}>
